...
function normalizeFeeSettings(payload) {
  return {
    ...
    maximum_service_fee_etb: Number.isFinite(Number(payload.maximum_service_fee_etb)) ? Math.max(0, Number(payload.maximum_service_fee_etb)) : 0,
    enable_minimum_fee: payload.enable_minimum_fee ? 1 : 0,
