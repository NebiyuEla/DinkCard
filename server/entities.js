...
function normalizeFeeSettings(payload) {
  return {
    ...
    gateway_fee_percentage: Number.isFinite(Number(payload.gateway_fee_percentage)) ? Number(payload.gateway_fee_percentage) : 5.6,
    ...
    total_amount_fee_percentage: Number.isFinite(Number(payload.total_amount_fee_percentage)) ? Math.max(0, Number(payload.total_amount_fee_percentage)) : 0,
